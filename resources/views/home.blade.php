        ...
        <div class="carousel-inner">
            <div class="carousel-item full text-center active">
                <a href="/detail/detailFilms/37" class="link-img-carousel">
                    <img src="{{$film[36]->poster_path}}" class="img-carousel px-2 px-sm-2" alt="Img {{$film[36]->name}}">
                </a>
                <a href="/detail/detailFilms/38" class="link-img-carousel">
                    <img src="{{$film[37]->poster_path}}" class="img-carousel px-2 px-sm-2" alt="Img {{$film[37]->name}}">
                </a>
                <a href="/detail/detailFilms/39" class="link-img-carousel">
                    <img src="{{$film[38]->poster_path}}" class="img-carousel px-2 px-sm-2" alt="Img {{$film[38]->name}}">
                </a>
            </div>
            <div class="carousel-item full text-center">
                <a href="/detail/detailSeries/37" class="link-img-carousel">
                    <img src="{{$serie[36]->poster_path}}" class="img-carousel px-2 px-sm-2" alt="Img {{$serie[36]->name}}">
                </a>
                <a href="/detail/detailSeries/38" class="link-img-carousel">
                    <img src="{{$serie[37]->poster_path}}" class="img-carousel px-2 px-sm-2" alt="Img {{$serie[37]->name}}">
                </a>
                <a href="/detail/detailSeries/39" class="link-img-carousel">
                    <img src="{{$serie[38]->poster_path}}" class="img-carousel px-2 px-sm-2" alt="Img {{$serie[38]->name}}">
                </a>
            </div>
            <div class="carousel-item full text-center">
                <a href="/detail/detailAnimes/37" class="link-img-carousel">
                    <img src="{{$anime[36]->poster_path}}" class="img-carousel px-2 px-sm-2" alt="Img {{$anime[36]->name}}">
                </a>
                <a href="/detail/detailAnimes/38" class="link-img-carousel">
                    <img src="{{$anime[37]->poster_path}}" class="img-carousel px-2 px-sm-2" alt="Img {{$anime[37]->name}}">
                </a>
                <a href="/detail/detailAnimes/39" class="link-img-carousel">
                    <img src="{{$anime[38]->poster_path}}" class="img-carousel px-2 px-sm-2" alt="Img {{$anime[38]->name}}">
                </a>
            </div>
        </div>
        ...
        <div id="films" class="carousel slide carousel-equal-heights my-4" data-bs-ride="carousel"
            ...
            <div class="carousel-inner" role="listbox">
                <?php            
                    ...
                    for($j=$j; $j < 7; $j++) {
                        echo '<div class="col d-none d-lg-flex justify-content-center p-1">
                            <a href="/detail/detailFilms/'.$film[$k]->id.'">';
                            if($film[$k]->poster_path == NULL)
                            echo '<img src="/img/NoImg.jpg" class="img-carousel" alt="">';
                            else
