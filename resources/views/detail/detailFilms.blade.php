    ...
    <div class="container my-5 py-5">
        <div class="row d-flex justify-content-center">
            <div class="col-12">
                ...
                <form method="POST" action="{{route('review.save', ['id' => $film->id]) }}" id="create-comment" class="create_comment">
                    @csrf
                    <textarea name="description" id="description" cols="50" rows="1" placeholder="Escribe aqui tu comentario"></textarea>
                    <button class="btn" type="submit"><i class="fas fa-arrow-alt-circle-up fa-lg"></i></button>
                </form>
            </div>
        </div>
    </div>
