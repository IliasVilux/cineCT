...
<div class="col-12 col-lg-8 p-sm-5">
      ...
      <div class="tab-content">
        <div class="tab-pane fade show active" id="logIn">
          <div class="card">
            <div class="card-body">
            <form class="row g-3 needs-validation d-flex flex-column align-items-center p-2 p-sm-5 m-2" novalidate>
              <div class="col-12">
        ...
        <div class="card">
            ...
            <form class="row g-3 needs-validation d-flex flex-column align-items-center p-2 p-sm-5 m-2" novalidate>
              ...
              <div class="col-12 col-md-6 mb-2">
                ...
                <input type="email" class="form-control" id="emailRegister" placeholder="youremail@gmail.com" required>
                <div class="valid-feedback">
                  Looks good!
                </div>
              </div>
              <div class="col-12 col-md-6">
                ...
                <input type="password" class="form-control" id="passwordRegister" placeholder="New Password" required>
                <div class="valid-feedback">
                  Looks good!
                </div>
              </div>
              <div class="col-12 col-md-6">
                ...
                <input type="password" class="form-control" id="passwordRegister2" placeholder="Repeat Password" required>
                <div class="valid-feedback">
                  Looks good!
                </div>
              </div>
