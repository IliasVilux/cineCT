...
<div class="load-more-genres mt-5 text-center">
    <button class="btn btn-outline-secondary d-inline d-lg-none" type="button" data-bs-toggle="collapse"
        data-bs-target="#more-genres" aria-expanded="false" aria-controls="more-genres">
